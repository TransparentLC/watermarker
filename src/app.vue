                    ...
                    <v-tabs-window-item value="about" class="pa-4">
                        ...
                        <ul>
                            <li>
                                ...
                                <p><strong>提示：</strong>复制图片后在“编辑水印”或“加水印”按 <kbd>Ctrl+V</kbd> 或将图片拖拽到浏览器窗口，即可快速打开图片。</p>
                            ...
                            <li>
                                ...
                                <p>可以把制作好的浮雕水印保存，下次选择图片就可以直接使用，不需要再启用“浮雕化”。保存的水印也可以在 Photoshop 等图像编辑软件中通过“叠加”使用。</p>
                                <p>如果分享水印的平台不支持上传透明图片，可以启用“使用灰色背景”，在使用“叠加”添加水印时不会有额外影响。</p>
                            </li>
                            <li>
...
// 预加载示例水印和图片
['assets/watermark-sample.webp', 'assets/image-sample.avif'].map(e => (document.createElement('img').src = e));
</script>
