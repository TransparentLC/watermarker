...
* 支持制作浮雕水印，并使用叠加/柔光添加到图片上。
* 可以将水印图片单独保存。
* 可以设定保存加水印后的图片时使用的格式及压缩质量。

## 借物表

* Webfont：[中文网字计划](https://chinese-font.netlify.app/)
* 示例用图片水印：[BOOTH @tenori-tei](https://booth.pm/ja/items/8665012)
* 背景图案：[柔造（“版权保护”设置页面）](https://rouzao.com/user/copyright)
